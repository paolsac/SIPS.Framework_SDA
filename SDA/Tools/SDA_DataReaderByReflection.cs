...
namespace SIPS.Framework.SDA.Tools
{
    ...
    public interface ISDA_DataReaderByReflection<T> : IDataReader
    {
        List<T> Records { get; set; }
    }

    public class SDA_DataReaderByReflection<T> : ISDA_DataReaderByReflection<T>
    {
        private int _currentIndex = -1;
        private readonly PropertyInfo[] _propertyInfos;
        private readonly Dictionary<string, int> _nameDictionary;

        public SDA_DataReaderByReflection()
        {
        ...
        public SDA_DataReaderByReflection(List<T> records) : this()
        {
            Records = records;
        }
